                      ...
                      <div className="flex align-middle text-sm font-semibold" >
                        {
                          project.repository_link ?
                            <a target="_blank" href={project.repository_link} >
                              <img className="w-7 h-7 rounded-10 mx-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/2048px-Octicons-mark-github.svg.png" alt="github-logo" />
                            </a>
                            :
                            ''
                        }
